...
<div class={cn("edra", className)}>
	...
	{#if !editor}
		<div
			class="flex size-full items-center justify-center gap-4 text-xl"
		>
	...
	<div
		...
		class="edra-editor prose h-full min-w-full cursor-auto p-2 dark:prose-invert *:outline-none"
	></div>
</div>
